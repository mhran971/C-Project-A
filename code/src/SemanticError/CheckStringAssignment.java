...
public class CheckStringAssignment {
    ...
    public static void checkStringAssignment(BaseScope currentScope,
                 ParserRuleContext ctx, String variableName, String assignedValue) {
        ...
        if ("string".equals(type)) {
            if (assignedValue == null) {
                String errorMsg = "❌Type error: variable '" + variableName +
                        "' is string but assigned value is not string at line " + currentLine;
