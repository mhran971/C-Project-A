// Generated from E:/Fourth year/Semester2(2024-2025)/Compiler 2/ProjectCompiler2_git/Compiler-Project-Angular/code/src/antlr/AngularLexer.g4 by ANTLR 4.13.2
package antlr;
...
public class AngularLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"MultiLineComment", "SingleLineComment", "WS", "NEWLINE", "Import", "Export", 
			"From", "Out", "Property", "Ensure", "EnsureAlways", "Check", "Mixin", 
			"Extends", "Super", "Implements", "Let", "Component", "CommonModule", 
			...
			"RegularExpressionBackslashSequence", "HTML_COMMENT", "HTML_CONDITIONAL_COMMENT", 
			"XML", "DTD", "SCRIPT_OPEN", "STYLE_OPEN", "TAG_OPEN_1", "TAG_SLASH", 
			"TAG_EQUALS", "TAG_NAME", "TEXT", "TAG_WHITESPACE", "DIGIT", "TAG_NameChar", 
			"TAG_NameStartChar", "SCRIPT_BODY", "SCRIPT_SHORT_BODY", "STYLE_BODY", 
			"STYLE_SHORT_BODY", "ATTRIBUT", "ATTCHARS", "ATTCHAR", "HEXCHARS", "DECCHARS", 
			"DOUBLE_QUOTE_STRING", "SINGLE_QUOTE_STRING", "CLASS_SELECTOR", "ID_SELECTOR", 
			"UNIT"
		};
	}
